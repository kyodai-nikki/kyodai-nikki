...
export const findEpisode = (
  ...
  episodes.find((s) => s.number === season)?.episodes.find((e) => e.slug === slug);
...
export const episodeLogHref = (seasonSlug: string, episodeSlug: string): string =>
  `/episodes/${seasonSlug}/${episodeSlug}/log/`;
